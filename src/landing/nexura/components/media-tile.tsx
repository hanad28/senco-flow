...
export default function MediaTile({ d, styles }: { d: MediaTileData; styles: MediaTileStyles }) {
  return (
    <li className="contents min-w-0">
      <div className={cn("w-full h-17.5 block relative shrink-0 max-lg:w-full md:max-lg:w-167 2xl:w-[22.4rem]", styles.className)} aria-hidden={d.ariahidden} name={d.name}>
